#' Make fake routes
#'
#' `make_fake_routes()` is a helper function used in testing `Routes`,
#' `BirdFlowRoutes`, and `BirdFlowIntervals`.
#'
...
make_fake_routes_one_point_per_route <- function() {
  route_df <- data.frame(
    route_id = c("001", "003", "004"),
    date = as.Date(c("2025-01-01", "2025-06-01", "2025-05-01")),
    lon = c(-75.0060, -85.6298, -95.3698),
    lat = c(39.7128, 40.8781, 29.7604),
    route_type = c("tracking", "motus", "motus")
  )
