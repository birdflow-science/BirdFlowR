...
new_BirdFlow <- function() {
  structure(list(geom = list(nrow = NA_integer_,
                 ...
                 metadata = list(
                   ...
                   ebird_access_end_date = NA_character_,
                   ebirdst_version = NA_character_,
                   birdflow_preprocess_date = NA_character_,
                   birdflow_model_date = NA_character_,
                   birdflow_version = 3,
                   birdflowr_preprocess_version = NA_character_,
                   birdflowr_version =
