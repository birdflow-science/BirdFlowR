...
#'
#' given a vector of timestep labels provide a vector of formated labels based
#' on the value of `birdflow_options("time_format")` (see that function for
#' options.)
#'
#' Internally distributions are labled with "t" and the timestep integer.
#' When returning them to the user [update_distr_labels()] is called to change
