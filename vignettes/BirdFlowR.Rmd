...
BirdFlowR generates synthetic migration routes and forecasts distributions
forward or backward through time. Here's a taste before we cover how it works.
...
```{r quick demo routes}
set.seed(0)
rts <- route(bf, n = 15, season = "prebreeding")
plot(rts, bf)
```
