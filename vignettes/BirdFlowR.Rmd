...
The metadata is a mix of information about the distributions and eBird model and information
generated while fitting the BirdFlow model. It includes the eBird version, the BirdFlowR version,
the date the model was fitted, and some of the arguments retained during model fitting.
